import { CreateSubNotificationRequest, DeleteSubNotificationRequest, InAppNotificationPatchRequest, InitConfiguration, queryLogsPostBody, RetractRequest, SendRequest, SetUserPreferencesRequest, User } from './interfaces.js';
...
declare class NotificationAPIService {
    ...
    updateInAppNotification: (userId: string, params: InAppNotificationPatchRequest) => Promise<AxiosResponse<any>>;
